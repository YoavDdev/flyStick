            ...
            <div className="mb-12 lg:mb-0">
              <div className="relative z-[1] block rounded-2xl px-6 py-12 shadow-md md:px-12 bg-[#F7F3EB] border border-[#D5C4B7] text-right transition-all duration-300 hover:shadow-lg">
                ...
                <p className="text-lg text-[#5C4B3E] mb-8">
                  באתר &ldquo;Studio Boaz Online&rdquo; (FlyStick), אנו מחויבים לספק חוויית כושר ובריאות נגישה לכל המשתמשים. 
                ...
                <p className="text-lg text-[#5C4B3E] mb-8">
                  ...
                  ומיישם עדכונים טכנולוגיים חדשים. אם יש קושי כלשהו או הצעות לשיפור, 
                  נשמח לשמוע ולטפל בנושא במהירות.
                </p>

                <p className="text-lg text-[#5C4B3E] mb-8">
                  <strong className="text-[#7D6E61]">יצירת קשר לנגישות</strong>
                  <br />
                  אם יש קושי נגישות כלשהו בפלטפורמה, הצעות לשיפור או שאלות בנושא נגישות, 
                  ניתן לפנות אלינו ונטפל בפנייה במהירות:
                  <br /><br />
