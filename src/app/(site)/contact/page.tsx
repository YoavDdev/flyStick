            ...
            <div className="mb-12 lg:mb-0">
              <div className="relative z-[1] block rounded-lg px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] dark:shadow-black/20 md:px-12 lg:-mr-14 bg-[#FCF6F5]">
                ...
                <p className="text-lg text-gray-700 mb-8">
                  ...
                  inquiries, or just want to say hello. I&apos;m here to assist
                  you with any information you may need. Whether it&apos;s about
                  a project, collaboration, or you simply want to connect,
                  I&apos;m just a message away. You can use the WhatsApp button
                  to send me a direct message, and I&apos;ll get back to you as
                  soon as possible. Your feedback and communication are
