...
const Contact = () => {
  return (
    <div className="container pt-28 mx-auto px-2">
      <section className="relative mb-6 ">
        <div className="relative w-full h-[500px]">
          ...
          />
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-6 bg-gradient-to-r from-black/70 to-transparent rounded-lg">
            <h2 className="mb-6 text-4xl font-bold text-white">צור קשר</h2>
            <p className="text-lg text-white mb-8 max-w-2xl">
              אל תהססו לפנות בשאלות, בקשות מיוחדות או סתם להגיד שלום. אני כאן כדי
              לדייק ולעזור עם כל מידע שאתם צריכים. בין אם זה שאלות שעלו
              מהשיעורים, או שיתוף פעולה והגעה אליכם. שלחו אלי הודעת וואטצאפ ואעשה
              את כל המאמצים לשוב אליכם בהקדם. המשוב והתקשורת ביננו חשובים לי מאד.
              בואו נהיה בקשר!
            </p>
            <Link
              href="https://wa.me/972527061212"
