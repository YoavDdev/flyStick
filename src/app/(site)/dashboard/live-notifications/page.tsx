      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#5D5D5D]">
            ניהול העדכונים על השיעורים החיים
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-[#5D5D5D] leading-relaxed">
                כשמפעילים עדכונים לשיעור, נשלח מייל אם יהיו שינויים - שינוי שעה, דחייה למועד אחר, או ביטול (חלילה!). 
                כך תמיד ניתן להישאר מעודכנים ולא לפספס שיעור.
              </p>
            </div>
          </div>
        </div>
        ...
        {registrations.length === 0 && (
          <div className="bg-white rounded-2xl border border-[#D5C4B7]/30 p-12 text-center">
            ...
            <h3 className="text-xl font-bold text-[#2D3142] mb-2">
              עדיין לא נרשמו לשיעורים
            </h3>
            <p className="text-[#5D5D5D] mb-6">
              לאחר הרשמה לשיעור חי, ניתן לנהל כאן את העדכונים
            </p>
            <Link
              href="/live"
