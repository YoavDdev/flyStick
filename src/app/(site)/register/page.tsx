    ...
    <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8 pb-96">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6" onSubmit={registerUser}>
          ...
          <div>
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="subscribeToNewsletter" className="text-sm font-medium leading-6 text-gray-900">
              להירשם לניוזלטר
            </label>
          </div>
        ...
        <button
          ...
          className="flex w-full justify-center px-4 py-1.5 border gap-2 border-slate-300 
                     rounded-lg text-slate-700 hover:border-slate-400 hover:text-slate-900 
