...
const Page = () => {
  ...
  const folderDescriptions = {
    ...
    "סטרונג-מובילי (פילאטיס מתקדמים)": " תרגולי זרימה מתקדמים ועשירים בדרגת כח וגמישות גבוהים.",
    "פילאטיס-לייט (פילאטיס לימודי)": " כאן תמצאו ׳שיעורי פתיחה׳ בהם אני פותח בהסבר מדויק על הנושא הנבחר.",
