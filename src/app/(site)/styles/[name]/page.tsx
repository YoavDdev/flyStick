...
const Page: FC<pageProps> = ({ params }) => {
  ...
  const folderDescriptions: { [key: string]: string } = {
    ...
    אביזרים: `כאן ניתן למצוא שיעורי גליל, כדור, צלחות ועוד. מטרתם לחדד ולהעמיק עקרונות שיתמכו בטכניקות השונות ובגוף במיוחד.`,
    ...
    "לימודי תודעה": `פרקים נבחרים של תובנות התבוננות וחקירה עצמית מוגשים כדי להבין טוב יותר את המציאות בה אנו חיים, לתרגם טוב יותר את הגוף הרגשי ולהיות בהרמוניה מול תנועת הארועים וחיי היומיום.`,
    ...
    "פילאטיס-לייט (פילאטיס לימודי)": `(פילאטיס לימודי למתחילים) כאן ניתן למצוא ׳שיעורי פתיחה׳ בהם אני פותח בהסבר מדויק על הנושא הנבחר, שיעורים בקצב איטי לתחילת הדרך ואף למתקדמים הרוצים להעמיק בפרטים הקטנים.`,
    "פילאטיס מכשירים": `שיעורים מטכניקת ה׳רפומר-פלו׳ המוגשת עד היום ברחבי הארץ. כאן ניתן למצוא שיעורי מורות מרחבי הארץ ומסדנאות בנושאים רבים המחדדים את התנועה של הגוף בזרימה.`,
