    ...
    switch (type) {
      case 'website':
        return {
          ...
          "url": baseUrl,
          "description": "בואו לצלול לשפע עצום של שיעורים ותרגילים שפותחו כדי להעשיר ולפתח את החיבור בין הגוף לנפש ולשדרג את המצב התפקודי עם אימונים וטכניקות ברמות קושי מגוונות. בועז נחייסי מלמד פלייסטיק, תנועה מרפאה ואימונים אישיים.",
          "inLanguage": "he-IL",
          "potentialAction": {
            "@type": "SearchAction",
