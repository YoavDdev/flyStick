      ...
      <div className="relative bg-[#F7F3EB] border-2 border-[#D5C4B7] rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 text-right leading-relaxed">
          <div className="space-y-4 text-[#3D3D3D]">
            <p>
              זהו, ההרשמה למנוי הושלמה ואני מאד שמח כי הסטודיו הוא סיכום הדרך הייחודית שבניתי מהחוויה האישית שלי ומשלל עצום של תובנות שקיבלתי וממשיכות להגיע וארזתי הכל לשיטות חדשניות הנגישות לכל אדם המעוניין להכיר את גופו ותודעתו.
            </p>
            
            <p>
              הצעד הזה מסמן התחלה של מסע- תנועתי, גופני, אישי, רגשי ותודעתי. מסע של היכרות עם הגוף לעומק, פיתוח מודעות סומאטית תחושתית, נשימה בתלת מימד ותנועה מתוך הקשבה. כל זאת בשפה פשוטה ונגישה שנוצרה מעבודת השטח לאורך השנים כשאני פוגש מאות אנשים בשבוע.
            </p>
            
            <p>
              אני מאמין שכל אדם- בכל גיל ובכל שלב- יכול/ה לגלות את העוצמה, הריפוי והחיוניות שטמונים בגוף וברוח.
            </p>
            
            <p>
              הסטודיו הזה הוא פרוייקט חיים והוא משלב אינספור רעיונות ותובנות שיעזרו לצלול למרחבים שביקרתי. הסטודיו מציע מסלולים שונים של הכשרה, שיעורים במבנים שונים, טכניקות רבות ועוד.
            </p>
            
            <p>
              קחו את הזמן. אל תמהרו. התחלה קטנה והמשכיות. להיות בהקשבה. זה לא מרתון. הגוף הוא חליפה גלקטית שמביעה את הלך רוחנו ולכן כל תנועה תביא סיפור ששווה לראות ולהרגיש.
            </p>
            ...
            <p>
              אני מאחל התחלה נעימה, שהות מסקרנת ופליאה, הרבה פליאה פנימית.
            </p>
            
            <div className="bg-[#D5C4B7]/20 rounded-lg p-4 mt-6">
              <p className="text-sm">
                שימו לב כי בתחתית האתר ניתן למצוא את המדריך השימושי לאתר בו ניתן לקבל הסברים כיצד להשתמש באתר ולהבין כיצד הוא בנוי.
              </p>
            </div>
