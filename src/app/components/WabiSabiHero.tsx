      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="text-center">
            ...
            >
              לצלול אל אוסף עצום נדיר של שיעורים ותרגולי גוף, שנבחרו בקפידה ומוגשים בכדי לחזק את הקשר בין הנפש לגוף ולהעצים את הרווחה האישית בעזרת טכניקות אימון מגוונות ורמות קושי מותאמות. אני מזמין להצטרף אל דרכי הייחודית להבין את החיים.
            </motion.p>
