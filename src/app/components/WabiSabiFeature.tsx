...
const WabiSabiFeature = () => {
  ...
  const features = [
    ...
    {
      name: "אם יש סקרנות פנימית ורצון לגלות ולהתפתח",
      description: "מחכות חקירות מעמיקות, סדר תרגולי ותנועתי מלווה בתובנות נדירות, זו הזמנה לחוות את ההרמוניה הטבעית בין התנועה החיצונית והתנועה הפנימית המתרחשות בסנכרון מופלא.",
      icon: "✿",
      color: "rgba(184, 160, 130, 0.9)",
    },
    {
      name: "מורים|ת, מדריכים|ת ומטפלים|ת",
      description: "שדרוג הידע והלימוד כיצד לתווך אותו למתאמנים בקלות ויצירתיות. מעקב אחר סילבוס חכם בתוכנית האימון הייחודית שלנו המבוססת על חקירה אישית ויצירת פתרונות מדויקים יותר עבור הלקוח. שדרוג הגוף והמקצועיות באותו זמן.",
      icon: "✧",
