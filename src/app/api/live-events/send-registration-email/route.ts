...
export async function POST(req: Request) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: user.email!,
      subject: `✅ נרשמת לשיעור: ${event.title}`,
      html: `
        <!DOCTYPE html>
            ...
            <tr>
              <td style="padding: 40px 30px;">
                ...
                <div style="background: #FFF9F0; border: 2px dashed #D5C4B7; border-radius: 15px; padding: 25px; margin-bottom: 30px;">
                  <h3 style="margin: 0 0 15px 0; color: #2D3142; font-size: 18px; display: flex; align-items: center; gap: 10px;">
                  ...
                  <div style="text-align: center;">
                    <a href="${updatePreferenceUrl}" style="display: inline-block; background: linear-gradient(135deg, #B56B4A 0%, #9a5a3d 100%); color: white; text-decoration: none; padding: 15px 40px; border-radius: 30px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 15px rgba(181, 107, 74, 0.3); transition: all 0.3s;">
